...
function mario:rightcollide(a, b)
	...
	elseif a == "button" then
		...
		return false
	elseif MarioModRightCollide[a] then

		if MarioModRightCollide[a](self, b) == false then return false end
...
function mario:leftcollide(a, b)
	...
	elseif a == "button" then
		...
		return false
	elseif MarioModLeftCollide[a] then

		if MarioModLeftCollide[a](self, b) == false then return false end
...
function mario:ceilcollide(a, b)
	...
	elseif MarioModCeilCollide[a] then

		if MarioModCeilCollide[a](self, b) == false then return false end
...
function mario:starcollide(a, b)
	--enemies that die
	if a == "goomba" or a == "koopa" or a == "plant" or a == "bowser" or a == "squid" or a == "cheep" or a == "hammerbro" or a == "lakito" or a == "bulletbill" or a == "flyingfish" or (modobjects[a] and modobjects[a].enemy) then
		b:shotted("right")
		if a ~= "bowser" then
